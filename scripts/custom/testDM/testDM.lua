...
if lastVote + time.seconds(180) > os.time() then
	lastVote = os.time()
  tes3mp.SendMessage(pid, color.Lime .. "[Deathmatch]" .. color.White .. "Voting has been started. Use /yes or /no for new map in the next 60 seconds.\n", true)
...
if voteYes == nil or voteNo == nil then return end
if cmd[1] == "yes" then
   voteYes = voteYes + 1
...
if voteYes > voteNo then
 ...
 tes3mp.SendMessage(pid, color.Lime .. "[Deathmatch]" .. color.White .. "Voting failed.", true)
end
