...
config.chatWindowInstructions = color.White .. "Use " .. color.Lime .. "Y" .. color.White .. " by default to chat or change it" ..
    " from your client config.\nType in " .. color.Lime .. "/help" .. color.White .. " to see the commands" ..
    " available to you.\nUse " .. color.Lime .. "F2" .. color.White ..
    " by default to hide the chat window or use the " .. color.Lime .. "Chat Window Mode" .. color.White .. " button from " ..
    "your left controller menu if you're in VR.\n"

--commented out in eventHandler.OnGUIAction (no reason to do it when running deathmatch script)
