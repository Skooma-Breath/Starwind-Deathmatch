Menus["help player"] = {
    text =
        color.Lime .. "/startvote\n" ..
            color.Silver .. "starts a vote to change the current map to a new random one\n" ..
        color.Lime .. "/yes\n" ..
            color.Silver .. "votes yes\n" ..
        color.Lime .. "/no\n" ..
            color.Silver .. "votes no\n" ..
        color.Lime .. "/newoutfit\n" ..
            color.Silver .. "gives you a new outfit only when playing DM\n" ..
        color.Lime .. "/switch\n" ..
            color.Silver .. "switch teams\n" ..
        color.Lime .. "/score\n" ..
            color.Silver .. "view score\n",
    buttons = {
        { caption = color.Lime .. "Deathmatch Admin Commands",
            displayConditions = {
                menuHelper.conditions.requireStaffRank(2)
            },
            destinations = {
                menuHelper.destinations.setDefault("dm admin commands")
            }
        },
        { caption = "Admin help",
            displayConditions = {
        ...
        { caption = "General Help",
            destinations = {
                menuHelper.destinations.setDefault("general help")
            }
        },
...
Menus["dm admin commands"] = {
    text =
        ...
        color.Lime .. "/newmap\n" ..
            color.Silver .. "creates new match data using the current cell location inside testDMMaps, testDMMatchSettings, and testDMConfig.matchList\n" ..
        color.Lime .. "/addspawn <team> (1 or 2)\n" ..
            color.Silver .. "uses your current location to create spawn locations for your newly created map\n" ..
        color.Lime .. "/forcend\n" ..
            color.Silver .. "ends the current match and starts a random new one\n" ..
        color.Lime .. "/newmatch <matchname>\n" ..
            color.Silver .. "used to start a new match of your choice\n" ..
        color.Lime .. "/matchlist \n" ..
            color.Silver .. "prints matchlist to console for now... matchList can be viewd in testDMConfig.matchList\n" ..
        color.Lime .. "/score\n" ..
            color.Silver .. "view score\n",
    buttons = {
        { caption = color.Lime .. "Deathmatch Commands",
            destinations = {
...
if config.allowSuicideCommand == true then
    Menus["general help"].text = Menus["general help"].text .. "\n" .. color.Yellow .. "/suicide\n" ..
